# Generated by Powerlevel10k configuration wizard on 2022-11-14 at 03:23 PST.
...
() {
  ...
  # changes without restarting zsh. Edit ~/.p10k.zsh and type `source
  # ~/.p10k.zsh`.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='ssh'
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=239
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=239
  ...
  typeset -g POWERLEVEL9K_GOENV_BACKGROUND=239
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=239
